...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # if self.frame_type == 'global':
        #     out_frame = out
        if self.frame_type == 'last':   #256
            out_frame = out
        elif self.frame_type == 'last_0':   #32
            out_frame = out0
        elif self.frame_type == 'last_1':   #32
            out_frame = out1
        elif self.frame_type == 'last_2':   #64
            out_frame = out2
        elif self.frame_type == 'last_3':   #128
            out_frame = out3
        
        if self.frame_type == 'fbank':   #256
            embed_fl = x.squeeze(1)
        else:
            embed_fl = out_frame.view(out_frame.shape[0],out_frame.shape[1],-1)
...
def ResNet34(feat_dim, embed_dim, pooling_func='TSTP', two_emb_layer=False, frame_type='last'):
