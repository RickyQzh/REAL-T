...
import wesep.models.bsrnn_HR as bsrnn_HR
import wesep.models.usef_tfgridnet as usef_tfgridnet
...
def get_model(model_name: str):
    ...
    elif model_name.startswith("BSRNN_HR"):
        return getattr(bsrnn_HR, model_name)
    ...
    elif model_name.startswith("USEF_TFGridNet"):
        return getattr(usef_tfgridnet, model_name)
