...
from wesep.models.local.get_layer_from_string import get_layer
...
class TF_gridnet_attentionblock(nn.Module):
    ...
    def __init__(
        ...
        )  # approx_qk_dim is only approximate  512 / 65 = 8
    ...
    def forward(self, batch, aux):
        ...
        Q = self["attn_norm_Q"](self["attn_conv_Q"](batch))  # [B, n_head, C, T, Q], [B, 4, 8, T, 65]
        K = self["attn_norm_K"](self["attn_conv_K"](aux))  # [B, n_head, C, T, Q]
        V = self["attn_norm_V"](self["attn_conv_V"](aux))  # [B, n_head, CV, T, Q], [B, 4, 32, T, 65]
