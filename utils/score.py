...
if __name__ == "__main__":
    # Example usage
    est = np.random.randn(16000)  # Simulated estimated signal
    ref = np.random.randn(16000)  # Simulated reference signal

    sisnr_score = cal_SISNR(est, ref)
    pesq_score = cal_PESQ(est, ref)
    stoi_score = cal_STOI(est, ref)

    print(f"SISNR: {sisnr_score}, PESQ: {pesq_score}, STOI: {stoi_score}")